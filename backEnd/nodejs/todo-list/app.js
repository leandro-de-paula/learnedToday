...
yargs.command({
    ...
    handler:  (argv) => {
        ...
        /**Primary estilo the view: 
         console.log(chalk.bold.green.inverse (`    Creating a new task with success: ${argv.name}    `))
         console.log(chalk.bold.green ("Descrição: ")+chalk.green(` ${argv.description} `))*/
         
         /**Segundary estilo the view: 
          const info = chalk.bold.green.inverse ("    Creating a new task with success:    ")
          
          console.log(`Name: ${argv.name}`)
          console.log(`Description: ${argv.description}`)*/
          
          /**Terceiro estilo the view: 
           const infoTitleGreen = chalk.bold.green.inverse
           const infoDestaqGreen = chalk.bold.green
           const infoWhite = chalk.white
           console.log(infoTitleGreen("    Creating a new task with success:    "))
           console.log(infoDestaqGreen("Name: ") + infoWhite(`${argv.name}`))
           console.log(infoDestaqGreen("Description: ") + infoWhite(`${argv.description}`))
           console.log(argv)
